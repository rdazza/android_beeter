...
import edu.upc.eetac.dsa.beeter.Client.entity.MediaType;
...
public class BeeterAPI {
    ...
    private BeeterAPI(Context context) throws IOException, BeeterClientException {
        super();
    ...
    public final static BeeterAPI getInstance(Context context) throws BeeterClientException {
        ...
        if (instance == null)
            try {
                ...
                throw new BeeterClientException(
                        "Can't load configuration file");
            }
        return instance;
    }

    private void getRootAPI() throws BeeterClientException {
        ...
        try {
            ...
            throw new BeeterClientException("Can't establish connection Beeter API Web");
        }
        ...
        try {
            ...
            throw new BeeterClientException("Error parsing Beeter Root API");
        }

    }
    private Map<String, Sting> stingsCache = new HashMap<String, Sting>();

    public Sting getSting(String urlSting) throws BeeterClientException {
        Sting sting = null;
        HttpURLConnection urlConnection = null;
        try {
